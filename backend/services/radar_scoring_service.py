...
class RadarScoringService:
    ...
    def __init__(self):
        ...
        self.university_tiers = {
            ...
            "tier_1": {
                "score_range": (95, 98),
                "universities": ["复旦大学", "上海交通大学", "浙江大学", "中国科学技术大学", "南京大学", "中国人民大学", "北京航空航天大学", "北京理工大学", "哈尔滨工业大学", "西安交通大学", "墨尔本大学", "悉尼大学", "苏黎世联邦理工学院", "新加坡国立大学", "南洋理工大学", "哥本哈根大学", "爱丁堡大学", "纽约大学", "伦敦大学学院", "华盛顿大学", "帝国理工学院", "哥伦比亚大学", "墨尔本", "杜克大学", "约翰斯·霍普金斯大学", "宾夕法尼亚大学", "加利福尼亚大学洛杉矶分校", "康奈尔大学", "卡内基梅隆大学", "伦敦政治经济学院", "加利福尼亚大学圣迭戈分校"]
            },
